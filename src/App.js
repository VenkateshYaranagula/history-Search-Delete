...
class App extends Component {
  state = {
    searchInput: '',
    searchHistory: initialHistoryList,
  }
  ...
  render() {
    ...
    const searchResults = searchHistory.filter(eachUser =>
      ...
      <div>
        <div className="logoInitial">
          ...
          <div>
            ...
            />
            {searchInput ? <p>There is no history to show</p> : null}
          </div>
        </div>

        <ul className="shadowing">
